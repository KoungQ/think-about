...
[다음 장](Spring%20MVC%20%EC%9A%94%EC%B2%AD%20%EC%B2%98%EB%A6%AC%20%ED%9D%90%EB%A6%84%20%284%29%20-%20ViewResolver.md)에서는 반환값이 실제 HTTP 응답으로 변환되는 과정인 **응답 구조**를 다룰 예정이다.
